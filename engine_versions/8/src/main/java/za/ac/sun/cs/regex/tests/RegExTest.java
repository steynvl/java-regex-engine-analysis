...
package za.ac.sun.cs.regex.tests;
...
public class RegExTest {
    ...
    private static void nullArgumentTest() {
        ...
        check(new Runnable() { public void run() { m.appendTail(nullSb);}});
        check(new Runnable() { public void run() { m.replaceAll(nullString);}});
        check(new Runnable() { public void run() { m.replaceFirst(nullString);}});
        check(new Runnable() { public void run() { m.appendReplacement(nullSb, nullString);}});
    ...
    */
    ...
    private static void processFile(String fileName) throws Exception {
        File testCases = new File(
                System.getProperty("user.dir", ".") + "/src/main/java/za/ac/sun/cs/regex/tests",
                fileName);
